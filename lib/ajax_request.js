...
function watchGeoPositionAndSave(sub_id, geocode=false, callback = null) {
	...
	var wid = plus.geolocation.watchPosition((p) => {
	  ...
	  stopWatchGeoPosition()
	  watchGeoPositionAndSave(sub_id, geocode, callback)
	}, {geocode: geocode, provider: appInfo.platform=='ios'?'system':'baidu', coordsType: appInfo.platform=='ios'?'wgs84':'bd09ll', maximumAge: 1000*userInfo.watch_position_limit_time,timeout: 20000})
